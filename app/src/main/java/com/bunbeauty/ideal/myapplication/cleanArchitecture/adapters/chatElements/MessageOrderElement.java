...
public class MessageOrderElement implements View.OnClickListener {
    ...
    public MessageOrderElement(Message message, View view, Context context) {
       /* // для условий
        messageIsCanceled = message.isCanceled;
        messageIsMyService = message.isMyService;

        // содержание сообщения
        String messageUserName = message.userName;
        String messageServiceName = message.serviceName;
        messageWorkingDay = message.workingDay;
        workingDayUserFormat = WorkWithStringsApi.dateToUserFormat(messageWorkingDay);
        messageWorkingTime = message.workingTime;
        messageTime = message.messageTime;

        // для Reference
        userId = message.userId;
        serviceId = message.serviceId;
        workingDayId = message.workingDayId;
        workingTimeId = message.workingTimeId;
