...
public class MessageReviewElement implements View.OnClickListener {
    ...
    public MessageReviewElement(Message message, View view, Context context) {
      ...
      /*  // для условий
        boolean isCanceled = message.isCanceled;
        messageType = message.type;
        messageRatingReview = message.ratingReview;

        // содержание сообщения
        // нету в сообщении
        this.messageUserId = message.userId;
        this.messageServiceId = message.serviceId;
        String messageUserName = message.userName;
        String messageServiceName = message.serviceName;
        String workingDayUserFormat = WorkWithStringsApi.dateToUserFormat(message.workingDay);
        String messageWorkingTime = message.workingTime;
